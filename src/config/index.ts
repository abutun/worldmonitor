...
// VITE_VARIANT=tech → tech.cosmicmeta.ai (tech-focused)
// VITE_VARIANT=full → cosmicmeta.ai (geopolitical)
// VITE_VARIANT=finance → finance.cosmicmeta.ai (markets/trading)
